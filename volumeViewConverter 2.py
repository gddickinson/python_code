...
recordingFolder = "%r" % sys.argv[1]
exportFolder = "%r" % sys.argv[2]
nSteps = int(sys.argv[3])
shift_factor = int(sys.argv[4])
theta = int(sys.argv[5])
triangle_scan = ast.literal_eval(sys.argv[6])
interpolate = ast.literal_eval(sys.argv[7])
trim_last_frame = ast.literal_eval(sys.argv[8])
zscan = ast.literal_eval(sys.argv[9])
...
#testing parameters
#recordingFolder = r"C:\Users\George\Desktop\testRun\george_1color"
