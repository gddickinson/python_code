...
class HelloWindow(QtGui.QMainWindow):
	...
	def on_hello_clicked(self):
         print("cliked")
         QtGui.QMessageBox.information(self, "Hello!", "Hello %s" % self.hello_edit.displayText(), QtGui.QMessageBox.Ok)
         print("messagebox displayed")

if __name__ == "__main__":
    # Someone is launching this directly
    #Check if old QCoreAplication.instance not deleted from kernel (i.e. in SPYDER)
