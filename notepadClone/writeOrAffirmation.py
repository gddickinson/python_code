...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.timer_Action = QAction("Stop Timer", self)
        self.timer_Action.setStatusTip("Stop Timer")
        self.timer_Action.triggered.connect(self.stopTimer)
        edit_toolbar.addAction(self.timer_Action)
        edit_menu.addAction(self.timer_Action)
    ...
    def stopTimer(self):
        ...
        if stop == QMessageBox.Yes:
            startGUI.stopApp()
            self.timer_Action.setVisible(False)
        return
...
class StartWin(QMainWindow):
    ...
    def __init__(self):
        ...
        self.qlabel_2.setText('How long do you want to write for?')
...
class Alarm(QObject):
    ...
    def __init__(self):
        ...
        pygame.mixer.init()
        soundFolder = os.path.join(os.path.basename(__file__), 'sounds')
        
        self.alarm_sound_1 = pygame.mixer.Sound(r"sounds\CRASH.wav")
        self.alarm_sound_2 = pygame.mixer.Sound(r"sounds\SNROLL_2.wav")   
        self.alarm_sound_3 = pygame.mixer.Sound(r"sounds\foghornWAV.wav")  
    ...
    def alarm(self, value):
        ...
        if value == 1:
            print('alarm 1')
            pygame.mixer.Sound.play(self.alarm_sound_1)            
        elif value == 2:
            print('alarm 2')
            pygame.mixer.Sound.play(self.alarm_sound_2)            
        elif value == 3:
            print('alarm 3')  
            pygame.mixer.Sound.play(self.alarm_sound_3)
