...
searchCells = arcpy.GetParameterAsText(1) # Needs to be a int
searchCells = int(searchCells)

smooth_flag = arcpy.GetParameterAsText(2)
smooth_flag = str_to_bool(smooth_flag)

z_raster = arcpy.GetParameterAsText(3)
z_units = arcpy.GetParameterAsText(4)
block_size =  arcpy.GetParameterAsText(5)
block_size = int(block_size)

overwrite_data = arcpy.GetParameterAsText(6)
