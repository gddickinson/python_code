...
#streamline_fc = r"C:\Google Drive\SiCr_Digitization\Shade_a_lator\TNC_2017\GIS\SilverCreek_Shade.gdb\TTools_Input\traced_river_upper_section_branch2_2_centerLine"
sid_field = "Id"
#node_dx = 50
#cont_stream_km = True
#checkDirection = True
...
node_dx = arcpy.GetParameterAsText(1)
node_dx = float(node_dx)

cont_stream_km = arcpy.GetParameterAsText(2)
cont_stream_km = str_to_bool(cont_stream_km)

checkDirection = arcpy.GetParameterAsText(3)
checkDirection = str_to_bool(checkDirection)
