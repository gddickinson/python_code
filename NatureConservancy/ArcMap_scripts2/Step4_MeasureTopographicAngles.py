...
#topo_directions = 1
#searchDistance_max_km = 0.1
#z_raster = r"C:\Google Drive\SiCr_Digitization\Shade_a_lator\TNC_2017\GIS\SilverCreek_Shade.gdb\LidarDEM"
#z_units = "Meters"
#topo_fc = r"C:\Google Drive\SiCr_Digitization\Shade_a_lator\TNC_2017\GIS\SilverCreek_Shade.gdb\Topo_nodes_traced_river_upper_section_branch2_2_100m"
...
topo_directions = arcpy.GetParameterAsText(1) # Needs to be a long
topo_directions = int(topo_directions)

searchDistance_max_km = arcpy.GetParameterAsText(2)
searchDistance_max_km = float(searchDistance_max_km)

z_raster = arcpy.GetParameterAsText(3)
z_units = arcpy.GetParameterAsText(4)
topo_fc = arcpy.GetParameterAsText(5)
block_size = arcpy.GetParameterAsText(6)
overwrite_data = arcpy.GetParameterAsText(7)
...
try:
    ...
    if block_size in ["#", ""]:
        ...
        block_size = int(con_from_m * float(block_size) * 1000)
