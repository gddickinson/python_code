# -*- coding: utf-8 -*-
"""
Created on Tue Jan 24 11:28:48 2017
...
def detect_board(filename):
    ...
    for x in range (image_x):
        for y in range (image_y):
            ...
            #count board pixels
            elif image[x,y][r] > image[x,y][g] and image[x,y][r] > image[x,y][b] and image[x,y][g]/image[x,y][b] > 1.3 and image[x,y][g]/image[x,y][b] < 3 and image[x,y][r]/image[x,y][g] > 1.5 and image[x,y][r]/image[x,y][g] < 2.7:
                
                if image[x,y][r] > 125 and image[x,y][r] < 210 and image[x,y][g] > 40 and image[x,y][g] < 110 and image[x,y][b] > 15 and image[x,y][b] < 75:
...
#define path
path = r"C:\Users\George\Dropbox\NatureConservancy\Image_Interpretation\PVER Photos\DL006\\"
file = r"IMG_2040.jpg"
filename = path + file
