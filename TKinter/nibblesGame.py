# -*- coding: utf-8 -*-
"""
Created on Sun Mar 20 00:52:05 2016
...
class Board(Canvas):
    ...
    def initGame(self):
        ...
        try:
            self.idot = Image.open("/home/george/Pictures/dot.png")
            self.dot = ImageTk.PhotoImage(self.idot)    
            self.ihead = Image.open("/home/george/Pictures/head.png")
            self.head = ImageTk.PhotoImage(self.ihead)           
            self.iapple = Image.open("/home/george/Pictures/apple.png")
