...
def sparsenet(patch_dim=64, neurons=128, lambdav=0.1, eta=6.0, num_trials=1500, batch_size=100, border=4, inference='lca'):
  """
  N: # Inputs
  M: # Outputs
  ...
  IMAGES = np.reshape(np.loadtxt('images', delimiter=','), (512, 512, 10))
