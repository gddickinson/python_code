...
def getList(showWanted = "test"):
    ...
    test = ([\      
        [Firework(startPosition=-50,setDirection=True,numberOfParticules=10, direction=1, explosionsOn=False, explosionDuration = 20, explosionTypeFlag=True, setRocketVelocity = True, rocketVelocity = -9, repeat=False, flare=True, flareSize =20),1],\
        ])
