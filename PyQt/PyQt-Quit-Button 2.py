...
#        The button is an instance of the QtGui.QPushButton class.
#         The first parameter of the constructor is the label of the button.
#        The second parameter is the parent widget.
#         The parent widget is the Example widget, which is a QtGui.QWidget by inheritance.        
#==============================================================================
...
#         The instance() method gives us its current instance.
