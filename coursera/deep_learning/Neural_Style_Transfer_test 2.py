...
#added#
content_image = scipy.misc.imread(r"images\top_mosaic_09cm_area2.tif")
content_image = to_grayscale(content_image)
content_image = content_image[0:800,0:800]
######
...
#added#
style_image = scipy.misc.imread(r"images\top_mosaic_09cm_area1.tif")
style_image = style_image[0:800,0:800]
#######
...
generated_image = np.clip(generated_image[0]/255., 0, 1)
...
def model_nn(sess, input_image, num_iterations = 1000):
    ...
    ### START CODE HERE ### (1 line)
    generated_image = sess.run(model['input'].assign(generate_noise_image(content_image)))   
    ### END CODE HERE ###
    ...
    for i in range(num_iterations):
        ...
        if i%20 == 0:
            ...
            save_image("output/test2_" + str(i) + ".png", generated_image)
    
    # save last generated image
    save_image('output/test2_generated_image.jpg', generated_image)
