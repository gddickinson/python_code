...
#IPython.display.Audio('./data/30s_seq.mp3') #notebook only

#outside notebook -> using pygame mixer
mixer.init()
mixer.music.load('./data/30s_seq.mp3') 
mixer.music.play()
...
mixer.music.load('output/my_music.midi') 
mixer.music.play()
