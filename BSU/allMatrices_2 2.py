...
backgroundCenteroids = np.array([[256.24,255.613],[255.898,256.36], [256.09,256.342]])


savePath = filePath.split('.')[0] + '_analysisResult.csv'
savePath2 = filePath.split('.')[0] + '_decodeResult.csv'
...
centeroids = centeroids + [[256.231,255.648],[255.898,256.36], [256.09,256.342], [255.977,256.151],[255.842,255.877]]
