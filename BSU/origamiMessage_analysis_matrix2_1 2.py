...
#set filepath
filePath = r"Y:\George_D_DATA\2019-09-05\from_Iapetus\20190905_Matrix2_syn2_pure_Triangles_300msExp_Mid-9nt-3nM_MgCl2_18mM_PCA_12mM_PCD_TROLOX_1mM_14_16_10_fixed_locs_picked_avg.hdf5"
...
filteredLocs = groupedLocs.loc[(groupedLocs.photons > 1600)]
...
def createPlot(df, groupNumber = 0, filterByPhotons = True, photonFilter = (1600,8000),filterByPrecision = True, precisionFilter = 0.025):
...
finalLocs = newLocs.loc[(newLocs.photons > 1600) & (newLocs.photons < 8000) & (newLocs.lpx < 0.04) & (newLocs.lpy < 0.04)]
