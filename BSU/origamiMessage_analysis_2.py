...
filePath = r"Y:\George_D_DATA\2019-08-30\20190830_Matrix5_syn2_pure_Triangles_300msExp_Mid-9nt-3nM_MgCl2_18mM_PCA_12mM_PCD_TROLOX_1mM_10_44_32_fixed_locs_picked_filtered_picked_avg.hdf5"
backgroundCenteroids = np.array([[255.849,256.19],[255.901,255.863], [256.096,255.755]])
...
for region in measure.regionprops(labels):
    ...
    if region.area >= 100 and region.area < 1200 and region.solidity > 0.8:
