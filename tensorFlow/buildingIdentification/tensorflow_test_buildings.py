...
from tf_utils import load_dataset, load_dataset_cat, random_mini_batches, convert_to_one_hot, predict_building
...
trainList = dataList[0:18000]
testList = dataList[18000:18200]
...
my_image_prediction = predict_building(my_image, parameters, imageVectorSize)
