...
from tf_utils import predict_buildings_5layers, convert_to_one_hot
import scipy
...
#load parameters
fileNumber = "20171017-210618_5layer"
...
image_predictions = predict_buildings_5layers(X_test, test_parameters, X_test.shape[1], imageVectorSize)
