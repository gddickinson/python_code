...
if __name__ == '__main__':
  ...
  filePath = r"C:\Users\George\Desktop\buildingClassifier\buildingList.csv"
  pointList = np.loadtxt(filePath,delimiter=",")

  for i in range(1917,len(pointList)):

      centerPoint = (pointList[i][0],pointList[i][1])
      ...
      saveImagePath = r"C:\Users\George\Desktop\idahoBuildings\building_" + str(i) + ".jpg"
