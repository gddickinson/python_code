...
def displayResults(folderPath, i):
    os.chdir(folderPath)
    fileList = []
...
arrayList = []
for i in range(3):    
    piece, pieceArray = displayResults(resultsPath, 1)
    pieceList.append(piece)
    arrayList.append(pieceArray)

newArray = np.hstack(arrayList)
piece = Image.fromarray(newArray)
