...
def ResNet50(input_shape = (100, 100, 3), classes = 2):
    """
...
dataList1 = glob.glob(r"D:\AerialImageDataset\AerialImageDataset\train\labelledImages\*.jpg")
...
#prescreen as some files dont load
dataList = []
i = 0
...
####Add Idaho notBuilding images
dataList_extra = glob.glob(r"C:\Users\George\Desktop\splitFolder\*.jpg")
dataList_extra2 = glob.glob(r"C:\Users\George\Desktop\splitFolder2\*.jpg")
dataList_extra3 = glob.glob(r"C:\Users\George\Desktop\idahoBuildings\*.jpg")

trainList = trainList + dataList_extra + dataList_extra2 + dataList_extra3
...
img_path = r"D:\AerialImageDataset\AerialImageDataset\train\labelledImages\crop_0_1049_building.jpg"
