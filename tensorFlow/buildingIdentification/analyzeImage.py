...
from tf_utils import predict_buildings, convert_to_one_hot
import scipy
...
image_predictions = predict_buildings(X_test, test_parameters, X_test.shape[1], imageVectorSize)
