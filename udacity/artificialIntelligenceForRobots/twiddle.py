# -*- coding: utf-8 -*-
"""
Created on Tue Nov 15 11:56:24 2016
...
def twiddle(tol = 0.2, n_params = 3): #Make this tolerance bigger if you are timing out!
############## ADD CODE BELOW ####################

    dparams = [1.0 for row in range(n_params)]
    params = [0.0 for row in range(n_params)]

    #dparams[2] = 0.0 #Turns off integral optimization
    #dparams[1] = 0.0 #Turns off differential optimization
