...
def rotateAboutVector(radians, args1=(0,0,0), args2=(0,0,0)):
...
def getSpheroid(args1=(0,0,0), args2=(0, 0, 0), resolution=10):
    return Spheroid(args1=args1, args2=args2, resolution=resolution)

def getHorizontalGrid(args1=(0,0,0), args2=(0,0), args3=(0,0)):
    return HorizontalGrid(args1=args1, args2=args2, args3=args3)